      ...
      <article className='section5-article'>
        ...
        <div className='section5-article-cards'>
          <div className='section5-article-card'>
            ...
            <p className='section5-article-card-details-header'>Choose Your Meals</p>
              <p className='section5-article-card-details-desc'>Lorem ipsum dolor sit amet,<br/> consectetur adipiscing elit, sed<br/> do eiusmod tempor </p>
              <div>
                <img className='section5-article-card-details-arrow' src={carrow3}/>
              </div>
            </div>
          </div>
          ...
          <div className='section5-article-card'>
            ...
            <div className='section5-article-card-details'>
              <p className='section5-article-card-details-header'>Track order</p>
              <p className='section5-article-card-details-desc'>Lorem ipsum dolor sit amet,<br/> consectetur adipiscing elit, sed<br/> do eiusmod tempor </p>
              <div>
                <img className='section5-article-card-details-arrow' src={carrow3}/>
              </div>
          ...
          <div className='section5-article-card'>
            ...
            <div className='section5-article-card-details'>
              <p className='section5-article-card-details-header'>Collect Order</p>
              <p className='section5-article-card-details-desc'>Lorem ipsum dolor sit amet,<br/> consectetur adipiscing elit, sed<br/> do eiusmod tempor </p>
              <div>
                <img className='section5-article-card-details-arrow' src={carrow3}/>
              </div>
