        ...
        <div className='section1-article-cards'>
            ...
            <div className='section1-article-card1-container'>
              <div className='section1-article-card1-header'>
                <div className='section1-article-card1-header-left'>
                    <p className='section1-article-card1-header-stars'>&#9733; &#9733; &#9733; &#9733; &#9733; &#124; 5.0</p>
                    <p className='section1-article-card1-header-desc'>5K+ Happy Review</p>
                </div>
              ...
              <div className='section1-article-card1-description'>
                <p className='section1-article-card1-description-top'>Crispy, Crunchy, Veggie Deliciousness!</p>
                <p className='section1-article-card1-description-bottom'>Burgers That<br/> Love the Earth!</p>
              </div>
          ...
          <div className='section1-article-card2'>
            <div className='section1-article-card2-container'>
              <div className='section1-article-card2-container-star'>
                <img className='section1-article-card2-star' src={aheadstar}/>
                <p className='section1-article-card2-star-desc'>75%<br/> OFF</p>
              </div>
              <div className='section1-article-card2-container-burger'>
                <img className='section1-article-card2-burger' src={aheadburger}/>
